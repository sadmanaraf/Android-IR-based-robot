...
boolean mode = LOW; // Low for android , High for sensor 
...
void SensorData(){
  ...
  if (position >=3000 && position <4500){ //move straight
      analogWrite(enA,120);
      analogWrite(enB,120);
  ...
  if(position >=4500 && position < 6800){ //move right
     analogWrite(enA,70);
     analogWrite(enB,70);
     digitalWrite(in1,HIGH);
     digitalWrite(in2,LOW);
